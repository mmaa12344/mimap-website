...
export default function MimapWebsite() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      {/* SEO Meta Tags */}
      <Head>
        <title>True Books HQ | Bookkeeping for Pest Control Companies</title>
        <meta
          name="description"
          content="Bookkeeping built for pest control companies — recurring service contract reconciliation, technician chemical supply tracking, and vehicle fleet expense management. QuickBooks experts serving businesses across the United States."
        />
        <meta
          name="keywords"
          content="pest control bookkeeping, bookkeeping services USA, QuickBooks bookkeeper, online bookkeeping, bookkeeping agency, remote bookkeeping"
        />
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-10 lg:pt-14 pb-12 lg:pb-16 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-5xl lg:text-7xl font-bold leading-tight tracking-tight">
              Modern <span className="text-blue-700">Bookkeeping</span> for Pest Control Companies
            </h2>

            <p className="mt-8 text-xl text-slate-600 leading-relaxed max-w-xl">
              Accurate books, monthly reports, reconciliations, and stress‑free finances — Based in St. Petersburg, Florida — serving pest control companies across the United States remotely..
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-3 items-stretch">
            ...
            <div className="bg-white rounded-[28px] border border-slate-100 p-10 shadow-sm hover:shadow-xl transition flex flex-col items-center text-center">
              ...
              <h3 className="mt-6 text-2xl font-bold text-slate-900">Solo Route Plan</h3>
              <p className="mt-2 text-slate-500">Perfect for solo operators and small pest control businesses</p>
            ...
            <div className="bg-white rounded-[28px] border-2 border-blue-700 shadow-2xl relative flex flex-col items-center text-center overflow-hidden">
              ...
              <div className="p-10 pt-8 flex flex-col items-center text-center flex-1 w-full">
                ...
                <h3 className="mt-6 text-2xl font-bold text-slate-900">Growing Fleet Plan</h3>
                <p className="mt-2 text-slate-500">Ideal for pest control companies with a growing fleet</p>
            ...
            <div className="bg-white rounded-[28px] border border-slate-100 p-8 shadow-sm">
              ...
              <div className="mt-6 overflow-hidden rounded-2xl border border-slate-100">
                <table className="w-full text-left">
                  ...
                  <tbody>
                    {[
                      ['Solo Route Plan', '$0.45'],
                      ['Growing Fleet Plan', '$0.43'],
                      ['Professional', '$0.4'],
                    ].map(([plan, rate], i) => (
      ...
      <section id="services" className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-5xl font-bold tracking-tight">Bookkeeping Services Designed for Pest Control Companies</h2>
            <p className="mt-6 text-xl text-slate-600">
              We reconcile your recurring monthly service contracts, track technician chemical supplies, and manage vehicle fleet expenses — flexible bookkeeping support built for pest control businesses across the United States.
            </p>
          </div>
              ...
              >
                ...
                <p className="mt-4 text-slate-600 leading-relaxed">
                  {service === 'Monthly Bookkeeping'
                    ? "We reconcile your recurring monthly service contracts, track technician chemical supplies, and manage vehicle fleet expenses."
